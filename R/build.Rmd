...
### Baseline 1
Below are the predictions on the testing set.  We can see that it never predicted children would be on the itinerary.
```{r echo=FALSE, error=FALSE, message=FALSE, warning=FALSE}
...
dev_lasso_cv = cv.glmnet(x, y, nfold=10, family="binomial")
